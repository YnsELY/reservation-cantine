...
import { ArrowLeft, Key, Plus, Copy, Trash2, CheckCircle, XCircle } from 'lucide-react-native';
  ...
  const loadCodes = async () => {
    try {
      ...
      const { data, error } = await supabase
        ...
        .select('*')
        .eq('provider_user_id', currentProvider.user_id)
  ...
  const handleCreateCode = async () => {
    ...
    try {
      ...
      const { error } = await supabase
        ...
        .insert({
          code: codeUpper,
          provider_user_id: currentProvider.user_id,
      ...
      <ScrollView style={styles.content} contentContainerStyle={styles.contentContainer}>
        <View style={styles.infoCard}>
          ...
          <Text style={styles.infoText}>
            Les écoles utiliseront ces codes pour créer leur compte et accéder à votre système de menus
          </Text>
        </View>
        ...
        <View style={styles.createCard}>
          ...
          <View style={styles.inputGroup}>
            ...
            <TextInput
              ...
              placeholder="Ex: Code pour École Primaire Paul Éluard"
              placeholderTextColor="#9CA3AF"
              maxLength={200}
            />
          </View>
