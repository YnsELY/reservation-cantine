...
interface ProviderRegistrationCode {
  id: string;
  code: string;
  is_active: boolean;
...
export default function ProviderAccessScreen() {
  const [codes, setCodes] = useState<ProviderRegistrationCode[]>([]);
  ...
  const handleToggleStatus = async (code: ProviderRegistrationCode) => {
    try {
      const { error } = await supabase
        .from('provider_registration_codes')
    ...
    <SafeAreaView style={styles.container} edges={['top']}>
      <View style={styles.topSection}>
        ...
        <View style={styles.badge}>
          <Text style={styles.badgeText}>Codes d'accès prestataire</Text>
        </View>
      </View>
      ...
      <ScrollView style={styles.content} contentContainerStyle={styles.contentContainer}>
        <View style={styles.infoCard}>
          ...
          <Text style={styles.infoTitle}>Créer des codes pour les prestataires</Text>
          <Text style={styles.infoText}>
            Les prestataires utiliseront ces codes pour créer leur compte et accéder à la plateforme
          </Text>
        </View>
        ...
        <View style={styles.createCard}>
          ...
          <View style={styles.inputGroup}>
            ...
            <TextInput
              ...
              placeholder="Ex: Code pour Prestataire XYZ"
              placeholderTextColor="#9CA3AF"
              maxLength={200}
            />
          </View>
        ...
        <View style={styles.instructionsCard}>
          ...
          <Text style={styles.instructionsText}>
            1. Créez un code unique pour chaque prestataire
          </Text>
          <Text style={styles.instructionsText}>
            2. Partagez le code avec le prestataire
          </Text>
          <Text style={styles.instructionsText}>
            3. Le prestataire utilise ce code lors de la création de son compte
          </Text>
          <Text style={styles.instructionsText}>
